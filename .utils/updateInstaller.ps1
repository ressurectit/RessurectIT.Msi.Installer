...
namespace RessurectIT.Utilities
{
	/// <summary>
...
$productWix = (Get-Content $productWixPath -Encoding UTF8 | Out-String).TrimEnd()
$newGuid = [RessurectIT.Utilities.GuidUtility]::Create($namespace, $fullVersion).ToString()
Write-Host "Product ID is '$newGuid'"

$productWix = [System.Text.RegularExpressions.Regex]::Replace($productWix, "<Product Id="".*?""", "<Product Id=""$newGuid""")

Set-Content $productWixPath $productWix -Encoding UTF8